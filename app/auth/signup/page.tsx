...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setError("Google sign-up temporarily unavailable. Please use email signup.")
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold text-slate-900">Woodora</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Create Your Account</h1>
          <p className="text-slate-600">Start designing your dream wooden furniture</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Sign Up</CardTitle>
            <CardDescription>Enter your details to create your Woodora account</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {success && (
                <div className="p-3 text-sm text-green-600 bg-green-50 border border-green-200 rounded-md flex items-center space-x-2">
                  ...
                  >
                    ...
                    <path d="M16.732 7.268 11 13 7.268 9.268" />
                  </svg>
                  <span>{success}</span>
                </div>
              )}
